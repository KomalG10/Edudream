...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "a35d3bff-4a1c-4f85-a877-8421196a3913");
  ...
  return (
    <div className='contact'>
      <div className="contact-col">
        ...
        <ul>
          <li><img src={mail_icon} alt="" />102002komalgupta@gmail.com</li>
          <li><img src={phone_icon} alt="" />+1 123-456-789</li>
          <li><img src={location_icon} alt="" />77 Massachusetts Ave, Cambridge <br />MA 01134, United States</li>
        </ul>
      </div>
      <div className="contact-col">
